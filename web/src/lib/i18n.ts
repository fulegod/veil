...
const dict = {
  en: {
    ...
    "inh.viewActionsHeader": "Scheduled actions",
    "inh.viewActionsHint":
      "off-chain dispatchers attached to this vault. each one is an Action entity on arkiv with a trigger_at timestamp and a payload. a vercel cron polls every hour and fires whatever is due.",
    "inh.viewActionsEmpty": "No scheduled actions for this vault.",
    "inh.viewActionWarning": "Pre-expiry warning email",
    "inh.viewActionDelivery": "On-expiry delivery email",
    "inh.viewActionTransfer": "On-expiry token transfer",
    "inh.viewActionDocDrop": "On-expiry document drop",
    "inh.viewActionFires": "Fires",
    "inh.viewActionDest": "To",
    "inh.viewActionStatusPending": "Pending",
    "inh.viewActionStatusFired": "Fired",
  ...
  es: {
    ...
    "inh.viewActionsHeader": "Acciones programadas",
    "inh.viewActionsHint":
      "dispatchers off-chain ligados a esta bóveda. cada uno es una entidad Action en arkiv con un timestamp trigger_at y un payload. un cron en vercel revisa cada hora y dispara lo que toque.",
    "inh.viewActionsEmpty": "No hay acciones programadas para esta bóveda.",
    "inh.viewActionWarning": "Email de aviso pre-expiración",
    "inh.viewActionDelivery": "Email de entrega al expirar",
    "inh.viewActionTransfer": "Transferencia de tokens al expirar",
    "inh.viewActionDocDrop": "Entrega de documento al expirar",
    "inh.viewActionFires": "Se dispara",
    "inh.viewActionDest": "A",
    "inh.viewActionStatusPending": "Pendiente",
    "inh.viewActionStatusFired": "Disparada",
